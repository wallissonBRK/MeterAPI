...
public class CreateCostumerViewModel : Notifiable<Notification>
{
    ...
    //    return new SmClientelicenca
    //    {
    //        SmClEmpresa = NomeEmpresa,
    //        SmClCnpj = CNPJ,
    //        SmClEmail = Email,
    //        SmClAplicativo = Aplicativo,
    //        SmClQuantLicencas = QuantidadeLicencas,
    //        SmClPeriodoLicenca = PeriodoLicenca
    //    };
    //}
